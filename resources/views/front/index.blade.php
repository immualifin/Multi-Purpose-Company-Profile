  ...
  <div id="header" class="bg-[#F6F7FA] relative overflow-hidden">
        ...
        <input type="hidden" name="path_video" id="path_video" value="{{ $hero->path_video}}">
          ...
          <div class="flex items-center gap-4">
            ...
            <button id="watchVideoBtn" class="bg-cp-black p-5 w-fit rounded-xl font-bold text-white flex items-center gap-[10px]">
    ...
    <div class="container max-w-[1000px] mx-auto py-10">
      <div class="flex flex-wrap items-center justify-between p-[10px]">
        ...
        <div class="card w-[200px] flex flex-col items-center gap-[10px] text-center">
          <div class="w-[55px] h-[55px] flex shrink-0 overflow-hidden">
            <img src="{{ Storage::url($stat->icon) }}" class="object-contain w-full h-full" alt="icon">
          </div>
          <p class="text-cp-pale-orange font-bold text-4xl leading-[54px]">{{ $stat->goal  }}</p>
          <p class="text-cp-light-grey">{{ $stat->name }}</p>
        </div>
            @empty
            <p>no data</p>
            @endforelse
